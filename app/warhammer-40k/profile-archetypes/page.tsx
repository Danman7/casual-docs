    ...
    <>
      ...
      <section>
        <p>
          ...
          possible target, so players manage this via archetypes. They are
          familiar benchmarks of effectiveness.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          <strong>Toughness, Save and Wounds</strong>, so common among units,
          that they have become benchmarks for how durable a model is. A profile
          can be a <em>strong example</em> when it matches an archetype closely,
          or a <em>loose example</em> if it comes close enough.
        </p>
        ...
        <p>
          ...
          at the same time <strong>show the limitations of AP</strong>. Once the
          Sv2+ is degraded to 4+, the Invulnerable Save takes over, so AP beyond
          -2 stops being useful. This promotes weapons with more Strength,
          enough Damage, and critical-related keywords, especially Devastating
          Wounds
          {"."}
        </p>
        ...
        <ul className="example">
          <li>
            The <strong>Flamer</strong> (Ad6 S4 D1 Torrent) auto-hits, wounds
            GEQ on 3+, and can remove as many models as its attacks roll allows.
          </li>

          <li>
            The <strong>Storm Bolter</strong> (A2 S4 D1 Rapid Fire 2 ) does 4
            attacks at half range.
          </li>

          <li>
            Any grenade or missile launcher with Blast makes more attacks the
            more targets there are.
          </li>
        </ul>
